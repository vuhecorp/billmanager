...
public final class VBillSummaryDeleteException extends Exception {
  public VBillSummaryDeleteException (String message) { 
      super(message); 
  } 
  public VBillSummaryDeleteException(Exception e) { 
      super(e); 
  } 
  public  VBillSummaryDeleteException(String msg, Exception e) {  
      super(msg, e);  
  }  
} 

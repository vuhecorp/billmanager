...
public final class VBillSummaryFinderException extends Exception {
  public VBillSummaryFinderException (String message) { 
      super(message); 
  } 
  public VBillSummaryFinderException(Exception e) { 
      super(e); 
  } 
  public  VBillSummaryFinderException(String msg, Exception e) {  
      super(msg, e);  
  }  
} 

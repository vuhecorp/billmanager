...
public final class VBillSummaryUpdateException extends Exception {
  public VBillSummaryUpdateException (String message) { 
      super(message); 
  } 
  public VBillSummaryUpdateException(Exception e) { 
      super(e); 
  } 
  public  VBillSummaryUpdateException(String msg, Exception e) {  
      super(msg, e);  
  }  
} 

...
public final class VBillSummaryCreateException extends Exception {
  public VBillSummaryCreateException (String message) { 
      super(message); 
  } 
  public VBillSummaryCreateException(Exception e) { 
      super(e); 
  } 
  public  VBillSummaryCreateException(String msg, Exception e) {  
      super(msg, e);  
  }  
} 

...
package com.hersa.sample.app.dao.bill;
              ...
              class BillDAOImplXA extends BillDAOImpl {                                
                  private static final Logger logger =                                             
                      Logger.getLogger(BillDAOImplXA.class);                           
                  private Connection conXA;                                                          
                  BillDAOImplXA() {                                                        
                      super();                                                                 
                      factory = new DefaultConnectionProvider(BillJNDI.XA_DATASOURCE);  
                  }                                                                                
                  public void open() {                                                             

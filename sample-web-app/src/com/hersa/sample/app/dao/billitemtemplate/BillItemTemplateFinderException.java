...
public final class BillItemTemplateFinderException extends Exception {
  public BillItemTemplateFinderException (String message) { 
      super(message); 
  } 
  public BillItemTemplateFinderException(Exception e) { 
      super(e); 
  } 
  public  BillItemTemplateFinderException(String msg, Exception e) {  
      super(msg, e);  
  }  
} 

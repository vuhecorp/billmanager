...
public final class BillItemCreateException extends Exception {
  public BillItemCreateException (String message) { 
      super(message); 
  } 
  public BillItemCreateException(Exception e) { 
      super(e); 
  } 
  public  BillItemCreateException(String msg, Exception e) {  
      super(msg, e);  
  }  
} 

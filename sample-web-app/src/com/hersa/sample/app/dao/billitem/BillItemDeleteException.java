...
public final class BillItemDeleteException extends Exception {
  public BillItemDeleteException (String message) { 
      super(message); 
  } 
  public BillItemDeleteException(Exception e) { 
      super(e); 
  } 
  public  BillItemDeleteException(String msg, Exception e) {  
      super(msg, e);  
  }  
} 

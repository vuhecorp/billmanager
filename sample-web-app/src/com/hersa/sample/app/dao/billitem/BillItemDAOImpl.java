...
class BillItemDAOImpl extends AbstractDAImpl implements BillItemDAO {
  ...
  protected String getSelectSQL(){
      String sql = " SELECT AMOUNT, BILL_ID, CREATED_BY, CREATED_ON, DATE_DUE, DESCRIPTION, ENTITY_CODE, ID, MODIFIED_BY, MODIFIED_ON, NAME, PAY_TO, RECURRING_CODE, STATUS, STATUS_DATE, TEMPLATE_ID, TIME_DUE, TYPE_CODE FROM " + getTable() + " " ;
      return sql;
}
  ...
  protected String getInsertSQL(){
      String sql = " INSERT INTO " + getTable() + " ( AMOUNT, BILL_ID, CREATED_BY, CREATED_ON, DATE_DUE, DESCRIPTION, ENTITY_CODE, MODIFIED_BY, MODIFIED_ON, NAME, PAY_TO, RECURRING_CODE, STATUS, STATUS_DATE, TEMPLATE_ID, TIME_DUE, TYPE_CODE ) VALUES  ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )";
      return sql;
}
  protected String getUpdateSQL(){
      String sql = " UPDATE " + getTable() + " SET  AMOUNT = ? , BILL_ID = ? , CREATED_BY = ? , CREATED_ON = ? , DATE_DUE = ? , DESCRIPTION = ? , ENTITY_CODE = ? , MODIFIED_BY = ? , MODIFIED_ON = ? , NAME = ? , PAY_TO = ? , RECURRING_CODE = ? , STATUS = ? , STATUS_DATE = ? , TEMPLATE_ID = ? , TIME_DUE = ? , TYPE_CODE = ?  WHERE ID = ? ";
      return sql;
}
...
public final int countBillItem(String whereClause, Object[] whereParams, int[] paramTypes ) { 
  ...
  public final BillItemDTO [] listBillItemByPK(long _Id) { 
     return listBillItemByPK( _Id, null);     
 } 

  public final BillItemDTO [] listBillItemByPK(long _Id, String orderByColumn) { 
  ...
  public final int countBillItemByPK(long _Id) { 
    String whereClause = " WHERE ID = ? ";       
    Object[] objs = new Object[1];   
    int[] types = new int[1];   
    objs[0] = new java.lang.Long(_Id);   

...
public final class BillItemFinderException extends Exception {
  public BillItemFinderException (String message) { 
      super(message); 
  } 
  public BillItemFinderException(Exception e) { 
      super(e); 
  } 
  public  BillItemFinderException(String msg, Exception e) {  
      super(msg, e);  
  }  
} 

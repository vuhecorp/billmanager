...
package com.hersa.sample.app.dao.billitem;
              ...
              class BillItemDAOImplXA extends BillItemDAOImpl {                                
                  private static final Logger logger =                                             
                      Logger.getLogger(BillItemDAOImplXA.class);                           
                  private Connection conXA;                                                          
                  BillItemDAOImplXA() {                                                        
                      super();                                                                 
                      factory = new DefaultConnectionProvider(BillItemJNDI.XA_DATASOURCE);  
                  }                                                                                
                  public void open() {                                                             
                  ...
                  protected Logger getLogger() {                                                   
                      return BillItemDAOImplXA.logger;                                     
                  }                                                                                
